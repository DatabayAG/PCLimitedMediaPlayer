...
class ilPCPluginExportImportStore
{
    ...
    {
        return ilPageComponentPluginExporter::getPCProperties($id);
    }
    ...
    {
        ilPageComponentPluginExporter::setPCVersion($id, $version);
    }
    ...
    {
        return ilPageComponentPluginExporter::getPCVersion($id);
    }
